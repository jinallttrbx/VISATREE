...
class CommonBottomSheet extends StatefulWidget {
  String userid;
  String shortlist;
  CommonBottomSheet(this.userid,this.shortlist);
    ...
    showModalBottomSheet(
        ...
        builder: (BuildContext bc) {
          return StatefulBuilder(builder: (BuildContext context,
            ...
            return CommonBottomSheet(userid,shortlist);
          });
        });
  }
}
...
class _CommonBottomSheetState extends State<CommonBottomSheet> {
  ...
  var shortlistuniversity=Get.put(ShortByuserController());
  UniversityController universityController = Get.find<UniversityController>();
  ShortByuserController shortlistuni=Get.find<ShortByuserController>();
  @override
  void initState() {
    ...
    shortlistuni.getShortUniversity();
    shortlistuni.getadminShortUniversity();
          ...
          child:  Container(
            ...
            child: Column(
              ...
              children: [
                ...
                courseDropDownValue==null?SizedBox.shrink() : Text("Course Price =$courseprice", style:TextStyle(
                  color: Colors.black,
                  fontSize: 15,
                  fontFamily: 'Poppins',
                  fontWeight: FontWeight.w600,
                ),),
                courseDropDownValue==null?SizedBox.shrink() : Text("Course Duration =$courseduration",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                    fontFamily: 'Poppins',
  ...
  child: Row(
    ...
    children: [
      ...
      duration: Duration(seconds: 2),
                ...
                try {
                  final response = await http.post(
                    Uri.parse( ApiUrl.shortlistuniversity
                    ),
                    headers: {"Authorization": "Bearer $token"},
                    body: {
                      "student_id": studentId,
