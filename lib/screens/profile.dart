...
import 'package:visatree/screens/editprofile.dart';
import 'package:visatree/screens/uploaddocuments.dart';
import 'package:visatree/session%20management.dart';
import 'package:visatree/util/images.dart';
import 'package:visatree/viewImage.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // String studaddress="";
  // String image='';
  SessionManagement sharepre = SessionManagement();
  // String studprofile="";
  // String firstname="";
  // String lastname="";
  @override
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child:
          Scaffold(body: GetX<ProfileController>(builder: (profilecontroller) {
