                                                    ...
                                                    Container(
                                                      ...
                                                      child: ElevatedButton(
                                                        ...
                                                        onPressed: () async{
                                                          ...
                                                          Get.find<ShortByuserController>();
                                                          shortunicontroller.ApplyUniversity(
                                                              universityController.shortbyadmin[position].id.toString(),universityController.shortbyuser[position].levelId.toString(),universityController.shortbyuser[position].programId.toString(),universityController.shortbyuser[position].courseId.toString(), context);
                                                        },
                                                        // {
                                                        //   SessionManagement share=SessionManagement();
                                                        //   showLoadingDialog();
