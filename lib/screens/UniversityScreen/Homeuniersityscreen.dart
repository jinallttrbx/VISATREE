...
import 'package:visatreenew/Widgets/commanbottomsheet.dart';
...
class HomeUniversity extends StatefulWidget {
  ...
  const HomeUniversity({super.key, required this.isDashBoard, this.countryId});
...
class _HomeUniversityState extends State<HomeUniversity> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: widget.isDashBoard == false
            ? AppBar(
                titleSpacing: 20,
                title: Row(
                  children: [
                ...
                : RefreshIndicator(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String html = universityController
                              .universityModel[index].description;
                                                  ...
                                                  Expanded(
                                                    child: SizedBox(
                                                      ...
                                                      child: ElevatedButton(
                                                        ...
                                                        child: Text(universityController
                                                                    .universityModel[
                                                                        index]
                                                                    .isshort ==
                                                                true
                    ...
                    onRefresh: () async {
                      await universityController.getUniversity(
