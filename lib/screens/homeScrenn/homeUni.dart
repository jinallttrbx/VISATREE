...
class HomeUniversityList extends StatefulWidget {
  ...
  @override
  State<HomeUniversityList> createState() => _HomeUniversityListState();
}

class _HomeUniversityListState extends State<HomeUniversityList> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: widget.isDashBoard
          ...
          titleSpacing: 0,
          title:
          Row(children: [boldtext(Colors.white, 18, "University")]),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: const ShapeDecoration(
                                color: AppColors
                                    .primaryColor2, //Color(0xFFD9D9D9),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.only(
                                    bottomLeft: Radius.circular(10),
                                    bottomRight: Radius.circular(10),
