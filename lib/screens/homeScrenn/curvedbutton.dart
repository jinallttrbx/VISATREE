      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Theme(
          ...
          child: CurvedNavigationBar(
            ...
            items: [
              _currentIndex == 0
                  ?  Image.asset(images.icon5,height: 25,color: AppColors.white,)
                  :  SizedBox(
                  height: 50,
                  child: Column(
              ...
              _currentIndex == 1
                  ?  Image.asset(images.icon4,height: 25,color: AppColors.white,)
                  :  SizedBox(
                  height: 50,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              _currentIndex == 2
                  ?   Image.asset(images.icon3,height: 25,color: AppColors.white,)
                  :  SizedBox(
                  height: 50,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              _currentIndex == 3
                  ?  Image.asset(images.icon2,height: 25,color: AppColors.white,)
                  :  SizedBox(
                  height: 50,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              _currentIndex == 4
                  ?    Image.asset(images.icon1,height: 25,color: AppColors.white,)
                  :  SizedBox(
                  height: 50,
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
